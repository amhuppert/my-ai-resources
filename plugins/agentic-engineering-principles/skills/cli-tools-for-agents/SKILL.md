...
description: Design a purpose-built project CLI as the primary tool surface for
  AI coding agents, instead of in-process tool or MCP servers. Covers the
  ...
  from in-process tool servers, designing tool output and error contracts, or
  deciding how agents should invoke project actions.
---
