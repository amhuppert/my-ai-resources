...
description: "Write or review agent instructions. Use when creating or editing skills, AGENTS.md, CLAUDE.md, system prompts, or reference documents agents consume."
---
