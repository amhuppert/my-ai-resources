...
description: "Write a reviewer's guide to a set of code changes: purpose, the fundamental decisions, a file-by-file review path, and the diff noise to skip."
disable-model-invocation: true
argument-hint: "[PR/MR number or URL | branch | path | description of the changes]"
---
