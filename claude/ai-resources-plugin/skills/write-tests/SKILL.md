---
name: write-tests
description: "Write automated tests, or decide whether code earns one. Covers mocking strategy (inject a test double before jest.mock), behavioral assertions, and code that resists testing."
---
